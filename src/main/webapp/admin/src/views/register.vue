  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">共享充电宝管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="用户手机" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghushouji" autocomplete="off" placeholder="用户手机" type="text" />
																								...
																								<!-- <div v-if="tableName=='weihurenyuan'" class="input-group">
			   <div class="label">人员账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.renyuanzhanghao" class="input" type="text" placeholder="人员账号">
			   </div>
			 </div> -->
			<el-form-item label="人员账号" class="input" v-if="tableName=='weihurenyuan'">
			  <el-input v-model="ruleForm.renyuanzhanghao" autocomplete="off" placeholder="人员账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='weihurenyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='weihurenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='weihurenyuan'" class="input-group">
			...
			<el-form-item label="人员姓名" class="input" v-if="tableName=='weihurenyuan'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='weihurenyuan'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='weihurenyuan'" class="input-group">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='weihurenyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.renyuanzhanghao) && `weihurenyuan` == this.tableName){
        this.$message.error(`人员账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `weihurenyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                    if(`weihurenyuan` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
                                                                                                                                          if(`weihurenyuan` == this.tableName && this.ruleForm.lianxifangshi&&(!this.$validate.isMobile(this.ruleForm.lianxifangshi))){
