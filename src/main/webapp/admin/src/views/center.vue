     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='yonghu'"  label="用户手机" prop="yonghushouji">
          <el-input v-model="ruleForm.yonghushouji"               placeholder="用户手机" clearable></el-input>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='weihurenyuan'"  label="人员账号" prop="renyuanzhanghao">
          <el-input v-model="ruleForm.renyuanzhanghao" readonly              placeholder="人员账号" clearable></el-input>
        </el-form-item>
      </el-col>
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='weihurenyuan'"  label="人员姓名" prop="renyuanxingming">
          <el-input v-model="ruleForm.renyuanxingming"               placeholder="人员姓名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item v-if="flag=='weihurenyuan'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                v-for="(item,index) in weihurenyuanxingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weihurenyuan'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="24">  
        <el-form-item v-if="flag=='weihurenyuan'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          ...
          @change="weihurenyuanzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='weihurenyuan'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item v-if="flag=='weihurenyuan'"  label="维护区域" prop="weihuquyu">
          <el-select v-model="ruleForm.weihuquyu" placeholder="请选择维护区域">
            <el-option
                v-for="(item,index) in weihurenyuanweihuquyuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
    ...
    return {
      ...
      usersFlag: false,
                                                                  yonghuxingbieOptions: [],
                                                                                                                        weihurenyuanxingbieOptions: [],
                                                            weihurenyuanweihuquyuOptions: [],
                                                                                                                                        };
  },
  mounted() {
      ...
      if (data && data.code === 0) {
        ...
        this.$message.error(data.msg);
                                            ...
                                            this.yonghuxingbieOptions = "男,女".split(',')
                                                                                this.weihurenyuanxingbieOptions = "男,女".split(',')
                                        this.$http({
      url: `option/quyuxinxi/quyu`,
      method: "get"
    }).then(({ data }) => {
      if (data && data.code === 0) {
        this.weihurenyuanweihuquyuOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
  ...
  methods: {
        ...
        this.ruleForm.touxiang = fileUrls;
                                                                                ...
                                                                                weihurenyuanzhaopianUploadChange(fileUrls) {
       ...
       this.$message.error(`年龄应输入整数`);
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.renyuanzhanghao)&& 'weihurenyuan'==this.flag){
        this.$message.error('人员账号不能为空');
        return
      }
                                                                  if((!this.ruleForm.mima)&& 'weihurenyuan'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
                                                                                                                                                                                    if( 'weihurenyuan' ==this.flag && this.ruleForm.nianling&&(!isIntNumer(this.ruleForm.nianling))){
       this.$message.error(`年龄应输入整数`);
        return
      }
                                                                                                                                          if( 'weihurenyuan' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
