  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shanghubianhao" label="商户编号" prop="shanghubianhao">
              <el-input v-model="ruleForm.shanghubianhao" 
                placeholder="商户编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="联系方式" prop="lianxifangshi">
              <el-input v-model="ruleForm.lianxifangshi" 
                placeholder="联系方式" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shanghutupian" label="商户图片" prop="shanghutupian">
          <file-upload
          tip="点击上传商户图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.shanghutupian?ruleForm.shanghutupian:''"
          @change="shanghutupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shanghutupian" label="商户图片" prop="shanghutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shanghutupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxifangshi = true;
            continue;
	            	            ...
	            	            if(o=='shanghutupian'){
            this.ruleForm.shanghutupian = obj[o];
	    this.ro.shanghutupian = true;
            continue;
          }
	                    }
                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `hezuoshanghu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.hezuoshanghuCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                ...
                                                                                                shanghutupianUploadChange(fileUrls) {
                this.ruleForm.shanghutupian = fileUrls;
				this.addEditUploadStyleChange()
            },
            	addEditStyleChange() {
	  this.$nextTick(()=>{
