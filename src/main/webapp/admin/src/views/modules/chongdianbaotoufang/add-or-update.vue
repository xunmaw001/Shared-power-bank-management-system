  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chongdianbaobianhao" label="充电宝编号" prop="chongdianbaobianhao">
              <el-input v-model="ruleForm.chongdianbaobianhao" 
                placeholder="充电宝编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="每小时费用" prop="meixiaoshifeiyong">
              <el-input v-model="ruleForm.meixiaoshifeiyong" 
                placeholder="每小时费用" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剩余电量" prop="shengyudianliang">
          <el-input v-model="ruleForm.shengyudianliang" 
              placeholder="剩余电量" clearable  :readonly="ro.shengyudianliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剩余电量" prop="shengyudianliang">
              <el-input v-model="ruleForm.shengyudianliang" 
                placeholder="剩余电量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="投放时间" prop="toufangshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.toufangshijian" 
                type="date"
                placeholder="投放时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toufangshijian" label="投放时间" prop="toufangshijian">
              <el-input v-model="ruleForm.toufangshijian" 
                placeholder="投放时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  data() {
	...
	shengyudianliang : false,
	toufangshijian : false,
      },
            ruleForm: {
                        chongdianbaobianhao: this.getUUID(),
                        	        shanghubianhao: '',
	                        	        shanghumingcheng: '',
	                        	        xiangxidizhi: '',
	                        	        pinpai: '',
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.meixiaoshifeiyong = true;
            continue;
	            	            ...
	            	            if(o=='shengyudianliang'){
            this.ruleForm.shengyudianliang = obj[o];
	    this.ro.shengyudianliang = true;
            continue;
          }
	            	            if(o=='toufangshijian'){
            this.ruleForm.toufangshijian = obj[o];
	    this.ro.toufangshijian = true;
            continue;
          }
	                    }
                                                                                                                                                                              }
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                        ...
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
        url: `chongdianbaotoufang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chongdianbaotoufang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chongdianbaotoufangCrossAddOrUpdateFlag = false;
                  this.parent.search();
