        ...
        <div v-else>
          <el-form-item class="input" label="人员姓名" prop="renyuanxingming">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.guzhangmiaoshu" label="故障描述" prop="guzhangmiaoshu">
                    <span>{{ruleForm.guzhangmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="处理结果" prop="chulijieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="处理结果"
                  v-model="ruleForm.chulijieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chulijieguo" label="处理结果" prop="chulijieguo">
                    <span>{{ruleForm.chulijieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chongdianbaoweihu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chongdianbaoweihuCrossAddOrUpdateFlag = false;
                  this.parent.search();
