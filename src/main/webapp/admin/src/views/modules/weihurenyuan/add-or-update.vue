  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="联系方式" prop="lianxifangshi">
              <el-input v-model="ruleForm.lianxifangshi" 
                placeholder="联系方式" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="维护区域" prop="weihuquyu">
          <el-select v-model="ruleForm.weihuquyu" placeholder="请选择维护区域">
            <el-option
                v-for="(item,index) in weihuquyuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="维护区域" prop="weihuquyu">
	      <el-input v-model="ruleForm.weihuquyu"
                placeholder="维护区域" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxifangshi = true;
            continue;
	            	            ...
	            	            if(o=='weihuquyu'){
            this.ruleForm.weihuquyu = obj[o];
	    this.ro.weihuquyu = true;
            continue;
          }
	                    }
                                                                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                this.weihuquyuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `weihurenyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weihurenyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
