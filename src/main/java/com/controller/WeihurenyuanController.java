...
public class WeihurenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WeihurenyuanEntity user = weihurenyuanService.selectOne(new EntityWrapper<WeihurenyuanEntity>().eq("renyuanzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"weihurenyuan",  "维护人员" );
    ...
    public R register(@RequestBody WeihurenyuanEntity weihurenyuan){
    	...
    	WeihurenyuanEntity user = weihurenyuanService.selectOne(new EntityWrapper<WeihurenyuanEntity>().eq("renyuanzhanghao", weihurenyuan.getRenyuanzhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        WeihurenyuanEntity user = weihurenyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
    	...
    	user.setMima("123456");
        weihurenyuanService.updateById(user);
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,WeihurenyuanEntity weihurenyuan, HttpServletRequest request){
        EntityWrapper<WeihurenyuanEntity> ew = new EntityWrapper<WeihurenyuanEntity>();
		PageUtils page = weihurenyuanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, weihurenyuan), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<WeihurenyuanEntity> wrapper = new EntityWrapper<WeihurenyuanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = weihurenyuanService.selectCount(wrapper);
